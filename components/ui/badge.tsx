...
const styles: Record<BadgeVariant, string> = {
  ...
  success:
    "border-green-500 bg-green-100/20 dark:bg-green-800/20 text-green-500",
}
...
export function Badge({
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center gap-1.5 border font-medium backdrop-blur-md",
        isCard
          ? "rounded-full px-2 py-1 text-[10px] md:text-xs"
          : "rounded-lg px-3 py-1 text-sm md:text-base",
        styles[variant],
        className
      )}
    >
